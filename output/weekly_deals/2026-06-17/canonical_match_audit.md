...
Generated: 2026-07-14T15:15:36.004011+00:00
...
- **Rejected:** 2
- **Manual review:** 1
- **Families updated:** doritos_5_13oz, cheetos_regular_bags, lays_potato_chips_regular, ruffles_regular_bags, sun_chips_7oz, cheez_it_crackers, goldfish_bags, pepsi_12packs, breyers_ice_cream, strawberries_1_2lb, cherries_per_lb, sweet_corn, butter_16oz, tri_tip_roast, salmon
...
- `ritz_crackers` (Safeway): blocked $2.49: hard negative keyword/pattern hit: toasted chips; multi-item variant list (or/comma) needs review; medium pattern confidence 0.68 needs review
...
- `ritz_crackers` (Safeway): **rejected**: 'Ritz Crackers or Toasted Chips, Nabisco Snack Crackers' @ $2.49
  - Reason: hard negative keyword/pattern hit: toasted chips; multi-item variant list (or/comma) needs review; medium pattern confidence 0.68 needs review
...
- `ritz_crackers`: 'Ritz Crackers or Toasted Chips, Nabisco Snack Crackers' @ $2.49: hard negative keyword/pattern hit: toasted chips; multi-item variant list (or/comma) needs review; medium pattern confidence 0.68 needs review
