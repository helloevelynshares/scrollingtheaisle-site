...
- `doritos_5_13oz` (Vons): "Lay's, Kettle Cooked, Poppables, Doritos, Ruffles, Smartfood, Cheetos, Fritos" @ $3.67 (confidence 0.70)
  - Display: Doritos
  - Subtitle: regular size, 5–13 oz
- `cheetos_regular_bags` (Vons): "Lay's, Kettle Cooked, Poppables, Doritos, Ruffles, Smartfood, Cheetos, Fritos" @ $3.67 (confidence 0.70)
  - Display: Cheetos
  - Subtitle: regular size, 6.5–10 oz
- `ruffles_regular_bags` (Vons): "Lay's, Kettle Cooked, Poppables, Doritos, Ruffles, Smartfood, Cheetos, Fritos" @ $3.67 (confidence 0.70)
  - Display: Ruffles
  - Subtitle: regular size, 5–13 oz
- `tostitos_tortilla_chips` (Vons): 'Gold Pretzels 10-16 oz. Tostitos Tortilla Chips 9-13 oz. Salsa 15.5 oz.' @ $5.0 (confidence 0.90)
  - Display: Tostitos tortilla chips
  - Subtitle: regular size, 9–13 oz
- `strawberries_1_2lb` (Vons): 'Strawberries 1 lb. package' @ $1.99 (confidence 0.90)
...
- `ribeye_steak` (Vons): 'Ribeye Steak' @ $7.99 (confidence 0.90)
  ...
  - Subtitle: per lb
- `salmon` (Vons): 'Fresh Atlantic Salmon Fillet' @ $7.97 (confidence 1.00)
  - Display: Salmon
  - Subtitle: fresh salmon fillet
- `smartfood_popcorn` (Vons): "Lay's, Kettle Cooked, Poppables, Doritos, Ruffles, Smartfood, Cheetos, Fritos" @ $3.67 (confidence 0.70)
  - Display: Smartfood popcorn
  - Subtitle: regular size, 4.75–11 oz
- `frito_lay_multipack_chips` (Vons): 'Frito-Lay Multipack 18 ct, Nabisco Multipack 12 ct' @ $9.99 (confidence 0.70)
  - Display: Frito-Lay variety pack
  - Subtitle: 18 ct multipack
- `chicken_wings_per_lb` (Vons): 'Signature Cafe Chicken Wings Party Pack' @ $24.99 (confidence 0.93)
